...
from .standards.cbers_p10 import transform_to_datacite as transform_cbers_p10
from .standards.cbers_p10 import xml_processor as cbers_p10_processor
...
def transform_to_datacite(settings, meta):
    ...
    elif standard == 'CBERS_P10':
        return transform_cbers_p10(settings, meta)
...
def get_processor(settings):
    ...
    elif settings['standard'] == 'CBERS_P10':
        return cbers_p10_processor
