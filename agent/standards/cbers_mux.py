...
# from agent.standards import get_unique_identifier
...
def transform_to_datacite(settings, meta):
    ...
    #     "identifierType": "DOI"
    # }
    # dc_data['immutableResource'] = {
    #     "resourceURL": "https://schema.datacite.org/meta/kernel-4.2/example/dummy.xml",
    #     "resourceChecksum": "1f4d92f643bf831131f7bd26bdb6d3e3",
    #     "checksumAlgorithm": "md5",
    #     "resourceName": "Dummy Example",
    #     "resourceDescription": "Dummy Example Description"
    # }
    return dc_data
